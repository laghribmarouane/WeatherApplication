...
import training.androidkotlin.weather.ville.Ville
...
class Database(context: Context)
    ...
    fun saveCity(city: Ville) : Boolean {
    ...
    fun getAllCities() : MutableList<Ville> {
        val cities = mutableListOf<Ville>()
    ...
    fun deleteCity(city: Ville) : Boolean {
